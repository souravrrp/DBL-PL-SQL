/* Formatted on 2/1/2022 12:41:57 PM (QP5 v5.374) */
SELECT XIB.BATCH_NAME,
 ...
 WHERE     1 = 1
       ...
       AND XIB.BATCH_NAME = '17462';

--------------------------------------------------------------------------------

SELECT *
  FROM XXDBL_ITEM_BATCHES XIB
 WHERE 1 = 1 AND XIB.BATCH_ID = '17462';

  SELECT XIM.*
    FROM XXDBL_ITEM_MASTER XIM
   WHERE 1 = 1 --AND XIM.BATCH_ID = '17462'
ORDER BY ITEM_CODE;

SELECT *
  FROM XXDBL_ITEM_ORG_HIERARCHY XIOH
 WHERE 1 = 1 AND XIOH.BATCH_ID = 17462;
...
UPDATE XXDBL_ITEM_BATCHES XIB
   SET BATCH_STATUS = 'NEW'
 WHERE 1 = 1 AND XIB.BATCH_ID = '17462';

UPDATE XXDBL_ITEM_MASTER XIM
   SET ITEM_STATUS = 'NEW'
 WHERE 1 = 1 AND XIM.BATCH_ID = '17462';