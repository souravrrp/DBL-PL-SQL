/* Formatted on 11/6/2021 10:24:57 AM (QP5 v5.365) */
...
SELECT xxdbl.formula_no,
       ...
       xxdbl.formula_desc1,
       xxdbl.formula_class,
       NVL (xxdbl.inactive_ind, 0)
           inactive_ind,
       ood.organization_id,
       DECODE (xxdbl.formula_type, 'Yes', 1, 0)
           formula_type,
       ...
       xxdbl.qty,
       xxdbl.detail_uom,
       (TO_NUMBER (NVL (xxdbl.scrap_factor, 0)) / 100)
           scrap_factor,
       ...
       xxdbl.attribute3,
       xxdbl.attribute1
           comments,                   -- Added By Manas on 06-Jan-2016 Starts
