/* Formatted on 1/19/2022 6:01:03 PM (QP5 v5.374) */
SELECT ledger_name,
       legal_entity_name,
       org_id,
       name,
       ...
       uom,
       (CASE
            WHEN pr_quantity < (po_quantity + grn_quantity)
            THEN
                0
            WHEN pr_quantity > (po_quantity + grn_quantity)
            THEN
        ...
        END)
           pr_quantity,
       (CASE
            WHEN po_quantity < grn_quantity THEN 0
            WHEN po_quantity > grn_quantity THEN po_quantity - grn_quantity
            ELSE po_quantity
        END)
           po_qty,
       po_quantity,
