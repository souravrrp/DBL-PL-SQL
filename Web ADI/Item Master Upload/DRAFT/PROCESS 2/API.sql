/* Formatted on 6/22/2020 5:07:29 PM (QP5 v5.287) */
CREATE OR REPLACE PROCEDURE T1_PROCESS_ITEMS
AS
...
BEGIN
   ...
   l_item_tbl (l_rowcnt).Segment1 := 'Test_Item_1';             -- Item Number
   l_item_tbl (l_rowcnt).Description := 'SU API TEST';     -- Item Description
   l_item_tbl (l_rowcnt).Organization_Code := 'V1';       -- Organization Code
