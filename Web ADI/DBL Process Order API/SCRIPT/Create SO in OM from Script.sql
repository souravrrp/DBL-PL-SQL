/* Formatted on 5/19/2021 4:46:31 PM (QP5 v5.287) */
DECLARE
...
BEGIN
   ...
   fnd_global.apps_initialize (5958, 53292, 660); -- pass in user_id, responsibility_id, and application_id
   MO_GLOBAL.INIT ('ONT');                                 -- Required for R12
   MO_GLOBAL.SET_POLICY_CONTEXT ('S', 126);                -- Required for R12
