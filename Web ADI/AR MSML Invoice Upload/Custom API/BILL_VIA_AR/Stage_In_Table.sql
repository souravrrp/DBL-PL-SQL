...
CREATE TABLE apps.ar_bill_upload_adi_stg
(
   SL_NO                NUMBER (35),
   --------------BILL HEADER----------------------------------------------------
...
ALTER TABLE apps.ar_bill_upload_adi_stg 
MODIFY (
...
DROP TABLE APPS.ar_bill_upload_adi_stg CASCADE CONSTRAINTS;