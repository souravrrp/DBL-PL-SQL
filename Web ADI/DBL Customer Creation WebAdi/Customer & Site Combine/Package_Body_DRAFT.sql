/* Formatted on 6/24/2021 12:23:24 PM (QP5 v5.287) */
...
IS
   ...
   FUNCTION new_customer_site_contact (p_cust_id         NUMBER,
            ...
            THEN
               ...
               CASE
                  ...
                  THEN
                     BEGIN
                        l_return_val :=
                           new_customer_site_contact (p_cust_id,
                                                      ln_party_site_id);
                        Fnd_File.PUT_LINE (
                           Fnd_File.LOG,
            ...
            BEGIN
               ...
               L_Retcode :=
                  new_create_customer_site (
                     TRIM (LPAD (xxdbl_customer_creation_s.CURRVAL, 7, '0')));
