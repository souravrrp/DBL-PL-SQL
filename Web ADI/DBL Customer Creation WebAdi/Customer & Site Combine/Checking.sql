/* Formatted on 6/24/2021 10:21:33 AM (QP5 v5.287) */
  SELECT *
    FROM xxdbl.xxdbl_cust_site_creation_tbl cct
...
--UPDATE xxdbl.xxdbl_cust_site_creation_tbl cct SET cct.status='Y' WHERE cct.cust_id = :p_cust_id;

--UPDATE xxdbl.xxdbl_cust_site_creation_tbl cct SET cct.payment_term='1000' WHERE cct.cust_id = :p_cust_id;

--TRUNCATE TABLE xxdbl.xxdbl_cust_site_creation_tbl;

DELETE xxdbl.xxdbl_cust_site_creation_tbl cct WHERE cct.status IS NULL;

--SELECT TRIM (LPAD (apps.xxdbl_cust_creation_s.NEXTVAL, 7, '0')) FROM DUAL;

UPDATE xxdbl.xxdbl_cust_site_creation_tbl
   SET CUSTOMER_NAME = 'DBLCL Test Customer 29'
 WHERE status IS NULL AND cust_id = 1000087;

COMMIT;

EXECUTE APPS.xxdbl_cust_creation_pkg.import_data_from_web_adi('DBLCL','','DBLCL Test Customer 28','R','CUSTOMER','','','','','DBLCL Customer 28, Corporate, Gulshan-1, Dhaka',	'LAKE PARK','GULSHAN','DHAKA','1212','Bangladesh','Area-1','Zone-A','N/A','A+','60 NET','100099','201.101.151.18809.511104.998.999.101.999','10000','sourav.paul@dbl-group.com','RETAILER','DBLCL Customer 28, Corporate, Gulshan-1, Dhaka',	'LAKE PARK','GULSHAN','Mr. Twist','0177777777','1212');

EXECUTE APPS.xxdbl_cust_creation_pkg.import_data_from_web_adi('DBLCL','152455','','','','','','','','','','','','','Bangladesh','Area-1','Zone-A','N/A','A+','60 NET','100099','201.101.151.18809.511104.998.999.101.999','10000','sourav.paul@dbl-group.com','RETAILER','DBLCL Customer 29, Corporate, Gulshan-1, Dhaka','LAKE PARK','GULSHAN','Mr. Twist 2','0177777777','1212');
 EXECUTE APPS.xxdbl_cust_creation_pkg.import_data_from_web_adi ('DBLCL','152455','','','','','','','','','','','','','Bangladesh','Area-1','Zone-A','N/A','A+','','100099','','','','Retailer','DBLCL Customer 29, Corporate, Gulshan-1, Dhaka','LAKE PARK','GULSHAN','Mr. KD 2','0177777777','1212')
...
ORDER BY CA.account_number DESC;
       ...
       EXECUTE APPS.xxdbl_cust_creation_pkg.import_data_from_web_adi('CCL2','Test Customer Upload 2','R','KSDKDSK','SEEW','JDFKFJ','IEWEWN','Test Customer 2, Corporate, Gulshan-1, Dhaka','LAKE','GULSHAN','DHAKA','1212');
