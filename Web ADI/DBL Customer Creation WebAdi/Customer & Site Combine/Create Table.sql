/* Formatted on 6/24/2021 9:34:01 AM (QP5 v5.287) */
CREATE TABLE xxdbl.xxdbl_cust_site_creation_tbl
(
...
CREATE OR REPLACE SYNONYM appsro.xxdbl_cust_site_creation_tbl FOR xxdbl.xxdbl_cust_site_creation_tbl;

CREATE OR REPLACE SYNONYM apps.xxdbl_cust_site_creation_tbl FOR xxdbl.xxdbl_cust_site_creation_tbl;

DROP TABLE xxdbl.xxdbl_cust_site_creation_tbl;



ALTER TABLE xxdbl.xxdbl_cust_site_creation_tbl
   ADD (Remarks VARCHAR2 (50));

ALTER TABLE xxdbl.xxdbl_cust_site_creation_tbl
   DROP COLUMN unit_name;

ALTER TABLE xxdbl_cust_site_creation_tbl
