/* Formatted on 5/30/2021 10:53:39 AM (QP5 v5.287) */
...
IS
   ...
   FUNCTION create_site_contact (p_cust_id NUMBER, p_part_site_id NUMBER)
      RETURN NUMBER
   IS
      CURSOR c
      IS
   ...
   BEGIN
      ...
      LOOP
         ...
         p_phone_rec.phone_number := SUBSTR ('01701213941', -11, 11);
   ...
   IS
      ...
      ln_cust_acct_site_id        NUMBER := lp_cust_acct_site_id;
      ln_site_use_id              NUMBER;
      --ln_site_use_id              NUMBER := lp_site_use_id;
   ...
   BEGIN
      ...
      LOOP
         ...
         l_cust_site_use_rec_type.bill_to_site_use_id := lp_site_use_id; --For Bill_To
   ...
   BEGIN
      ...
      LOOP
         ...
         l_return_val := create_site_contact (r.cust_id, ln_party_site_id);
         COMMIT;
         ...
         l_return_val := create_cust_profile_amnt (r.cust_id, ln_site_use_id);
         COMMIT;
