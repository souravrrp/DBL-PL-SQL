/* Formatted on 5/27/2021 12:56:36 PM (QP5 v5.287) */
...
IS
   ...
   PROCEDURE create_site_contact (p_cust_id NUMBER, p_part_site_id NUMBER)
   --RETURN NUMBER
   IS
      CURSOR c
      IS
   ...
   BEGIN
      ...
      LOOP
         ...
         */
         ...
         create_site_contact (r.cust_id, ln_party_site_id);
         COMMIT;
