/* Formatted on 5/30/2021 12:20:38 PM (QP5 v5.287) */
...
IS
   ...
   BEGIN
      ...
      LOOP
         ...
         --UPDATE xxdbl.xxdbl_cust_creation_tbl SET cust_acct_profile_amt_id = x_cust_acct_profile_amt_id WHERE cust_id = r.cust_id;
         --COMMIT;
