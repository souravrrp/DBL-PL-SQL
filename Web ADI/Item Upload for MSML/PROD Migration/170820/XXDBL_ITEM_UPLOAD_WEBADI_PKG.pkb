...
IS
   ...
   BEGIN
      ...
      LOOP
         BEGIN
            ...
            item_catelog_update (ln_cur_stg.segment1);
   ...
   IS
      ...
      IS
         SELECT FFV.FLEX_VALUE ct_item_type,
      ...
      IS
         SELECT FFV.FLEX_VALUE ct_item_count,
                val_set.ELEMENT_NAME ct_element_name
           FROM xxdbl.xxdbl_catalog_desc_elements val_set,
                apps.fnd_flex_values ffv
          WHERE     val_set.VALUE_SET_ID = ffv.flex_value_set_id
      ...
      IS
         SELECT FFV.FLEX_VALUE ct_product_type,
                val_set.ELEMENT_NAME ct_element_name
           FROM xxdbl.xxdbl_catalog_desc_elements val_set,
                apps.fnd_flex_values ffv
          WHERE     val_set.VALUE_SET_ID = ffv.flex_value_set_id
      ...
      IS
         SELECT FFV.FLEX_VALUE ct_item_content,
                val_set.ELEMENT_NAME ct_element_name
           FROM xxdbl.xxdbl_catalog_desc_elements val_set,
                apps.fnd_flex_values ffv
          WHERE     val_set.VALUE_SET_ID = ffv.flex_value_set_id
      ...
      IS
         SELECT FFV.FLEX_VALUE ct_item_style,
                val_set.ELEMENT_NAME ct_element_name
           FROM xxdbl.xxdbl_catalog_desc_elements val_set,
                apps.fnd_flex_values ffv
          WHERE     val_set.VALUE_SET_ID = ffv.flex_value_set_id
      ...
      IS
         SELECT FFV.FLEX_VALUE ct_item_process,
                val_set.ELEMENT_NAME ct_element_name
           FROM xxdbl.xxdbl_catalog_desc_elements val_set,
                apps.fnd_flex_values ffv
          WHERE     val_set.VALUE_SET_ID = ffv.flex_value_set_id
