/* Formatted on 1/16/2022 10:41:09 AM (QP5 v5.374) */
        ...
        LOOP
            BEGIN
                ...
                l_trx_lines_tbl (1).description :=
                    NVL (ln_cur_stg.ITEM_DESCRIPTION,
                         ln_cur_stg.LINE_DESCRIPTION);
