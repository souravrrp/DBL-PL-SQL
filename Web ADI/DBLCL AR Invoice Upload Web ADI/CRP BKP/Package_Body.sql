/* Formatted on 4/21/2021 9:24:47 AM (QP5 v5.287) */
   ...
   BEGIN
      ...
      LOOP
         BEGIN
            ...
            --XX_COM_PKG.GET_SEQUENCE_VALUE ('RA_CUSTOMER_TRX_ALL', 'CUSTOMER_TRX_ID');
            ...
            LOOP
               ...
               l_trx_lines_tbl (1).trx_header_id := ra_customer_trx_s.NEXTVAL; --101;
               --XX_COM_PKG.GET_SEQUENCE_VALUE ('RA_CUSTOMER_TRX_ALL', 'CUSTOMER_TRX_ID');
               l_trx_lines_tbl (1).trx_line_id :=
                  ra_customer_trx_lines_s.NEXTVAL;                      --401;
               --XX_COM_PKG.GET_SEQUENCE_VALUE ('RA_CUSTOMER_TRX_LINES_ALL','CUSTOMER_TRX_LINE_ID');
               l_trx_lines_tbl (1).line_number := ln_cur_stg.LINE_NUMBER;
               l_trx_lines_tbl (1).description := ln_cur_stg.LINE_DESCRIPTION;
