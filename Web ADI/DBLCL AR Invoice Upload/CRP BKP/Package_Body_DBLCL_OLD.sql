/* Formatted on 4/21/2021 12:14:43 PM (QP5 v5.287) */
   ...
   BEGIN
      ...
      LOOP
         BEGIN
            ...
            l_trx_header_tbl (1).trx_header_id := ra_customer_trx_s.NEXTVAL; --101;
            ...
            LOOP
               ...
               l_trx_lines_tbl (1).trx_header_id := ra_customer_trx_s.CURRVAL; --101;
               ...
               l_trx_dist_tbl (1).trx_header_id := ra_customer_trx_s.CURRVAL;
               l_trx_dist_tbl (1).trx_LINE_ID :=
                  ra_customer_trx_lines_s.CURRVAL;
               l_trx_dist_tbl (1).ACCOUNT_CLASS := 'REV';
               l_trx_dist_tbl (1).AMOUNT := ln_cur_stg.AMOUNT;
