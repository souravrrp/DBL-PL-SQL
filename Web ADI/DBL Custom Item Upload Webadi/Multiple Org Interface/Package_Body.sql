/* Formatted on 8/14/2021 2:31:45 PM (QP5 v5.287) */
...
IS
   ...
   BEGIN
      ...
      LOOP
         BEGIN
            ...
            LOOP
               BEGIN
                  vlp_template_name := ln_cur_stg.template;
                  vlp_category_id := 2125;

                  item_assign_template (ln_cur_stg.item_code,
                                        ln_org_hierarchy.organization_id,
                                        vlp_template_name);

                  assign_item_category (ln_cur_stg.item_code,
                                        ln_org_hierarchy.organization_id,
                                        vlp_category_id);
   ...
   BEGIN
      ...
      EXCEPTION
         ...
         THEN
            l_error_message :=
               l_error_message || ',' || 'Item Code already exists in the staging table.';
            l_error_code := 'E';
      END;
         ...
         EXCEPTION
            ...
            THEN
               l_error_message :=
                     l_error_message
                  || ','
                  || 'Please enter correct Item Category combination.';
               l_error_code := 'E';
         END;
      ELSE
         SELECT NULL
