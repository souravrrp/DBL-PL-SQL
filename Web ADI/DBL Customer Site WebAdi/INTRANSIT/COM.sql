/* Formatted on 5/19/2021 3:21:38 PM (QP5 v5.287) */
...
IS
   ...
   BEGIN
      ...
      LOOP
         ...
         IF ln_site_use_id IS NOT NULL AND gc_api_return_status = 'S'
         THEN
            p_contact_point_rec.contact_point_type := 'PHONE';
            p_contact_point_rec.owner_table_name := 'HZ_PARTY_SITES';
            p_contact_point_rec.owner_table_id := ln_party_site_id;
