/* Formatted on 6/16/2020 6:19:24 PM (QP5 v5.287) */
  SELECT SL_NO,
         ...
         flag
    --  ,STG.*
    FROM APPS.AR_BILL_UPLOAD_STG STG
   WHERE 1 = 1
...
DELETE FROM APPS.AR_BILL_UPLOAD_STG
...
EXECUTE APPS.ar_bill_upload_pkg.cust_upload_data_to_staging(16,'MSML','2027','USD','Yarn Export',84,'16-JUN-20','Sample','09-JUN-20',25,'YRN40S100CTN52199944',8,'10423001696',' ');
