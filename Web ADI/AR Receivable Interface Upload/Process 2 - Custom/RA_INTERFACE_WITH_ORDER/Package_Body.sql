/* Formatted on 6/25/2020 4:37:11 PM (QP5 v5.287) */
CREATE OR REPLACE PACKAGE BODY APPS.ar_interface_upld_adi_pkg
IS
   ...
   IS
      ...
      IS
         SELECT *
           FROM apps.ra_interface_table_stg
          WHERE FLAG IS NULL;
   BEGIN
      ...
      LOOP
         ...
         UPDATE apps.ra_interface_table_stg
            SET FLAG = 'Y'
          WHERE     FLAG IS NULL
   ...
   IS
      ...
      L_HEADER_ID                 NUMBER;
      L_TRANSACTIONAL_CURR_CODE   VARCHAR2 (100);
      L_FREIGHT_TERMS_CODE        VARCHAR2 (100);
      L_FREIGHT_CARRIER_CODE      VARCHAR2 (100);
      L_SALESREP_ID               NUMBER;
      L_LINE_ID                   NUMBER;
      L_INVENTORY_ITEM_ID         NUMBER;
      L_UNIT_SELLING_PRICE        FLOAT;
      L_ORDERED_QUANTITY          FLOAT;
      L_ORDERED_DATE              DATE;
      L_LINE_NUMBER               NUMBER;
      L_UNIT_LIST_PRICE           FLOAT;
      L_ACTUAL_SHIP_DATE          DATE;
   ...
   BEGIN
      ...
      */
      ...
      THEN
         BEGIN
            SELECT HCA.CUST_ACCOUNT_ID, HCAS.CUST_ACCT_SITE_ID
              INTO L_CUSTOMER_ID, L_BILL_TO_SITE_ID
              FROM HZ_PARTIES HP,
                   HZ_PARTY_SITES HPS,
      ...
      EXCEPTION
         ...
         THEN
            l_error_message :=
               l_error_message || ',' || 'Please enter correct order number.';
            l_error_code := 'E';
      END;
      ...
      THEN
         INSERT INTO apps.ra_interface_table_stg (SL_NO,
                                                  TRX_TYPE,
                                                  CUST_TRX_TYPE_ID,
                                                  ORGANIZATION_CODE,
                                                  BATCH_SOURCE_NAME,
                 ...
                 VALUES (
                           ...
                           TRIM (P_SALES_ORDER),
                           TRIM (P_ITEM_CODE),
                           TRIM (NVL (P_QUANTITY, L_ORDERED_QUANTITY)),
                           TRIM (
                              NVL (P_UNIT_SELLING_PRICE,
                                   L_UNIT_SELLING_PRICE)),
                           TRIM (L_OPERATING_UNIT),
                           TRIM (L_ORGANIZATION_ID),
                           TRIM (L_SET_OF_BOOKS),
                           TRIM (L_LEGAL_ENTITY_ID),
                           TRIM (NVL (L_ITEM_ID, L_INVENTORY_ITEM_ID)),
                           TRIM (L_UOM_CODE),
                           TRIM (L_AMOUNT),
                           TRIM (L_CUSTOMER_ID),
                           ...
                           TRIM (L_HEADER_ID),
                           TRIM (L_FREIGHT_TERMS_CODE),
                           TRIM (L_FREIGHT_CARRIER_CODE),
                           TRIM (L_SALESREP_ID),
                           TRIM (L_LINE_ID),
                           TRIM (L_ORDERED_DATE),
                           TRIM (L_LINE_NUMBER),
                           TRIM (L_UNIT_LIST_PRICE),
                           TRIM (L_ACTUAL_SHIP_DATE),
                           TRIM (L_TERRITORY_ID),
                           TRIM (L_T_SEGMENT1),
                           TRIM (L_T_SEGMENT2),
                           TRIM (L_T_SEGMENT3),
