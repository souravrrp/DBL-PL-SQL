...
*
from
xxdbl.xxdbl_cer_ra_interface_stg
where flag is null;
...
ra.*
   ...
   delete RA_INTERFACE_LINES_ALL ra where interface_line_id in (1940749
,1940740,
1940733); 
...
EXECUTE APPS.xxdbl_ar_interface_upload_pkg.upload_data_to_ar_int_stg (1,'251','DBLCL - Sales','Invoice','Tiles Local INV',1,'25-SEP-19','25-SEP-19','BDT','2597','NP6060-012GN',10,9);