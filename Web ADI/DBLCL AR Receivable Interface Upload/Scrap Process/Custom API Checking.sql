/* Formatted on 3/31/2021 10:15:23 AM (QP5 v5.287) */
...
--> Base Tables:
  ...
  SELECT *
   ...
   WHERE 1 = 1                   --AND TRUNC (CREATION_DATE) = TRUNC (SYSDATE)
              --AND trx_number = '421116208'--'421116207' 
              AND ORG_ID = 126
...
SELECT * FROM RA_INTERFACE_SALESCREDITS_ALL --DELETE RA_INTERFACE_DISTRIBUTIONS_ALL where TRUNC(CREATION_DATE) = TRUNC(SYSDATE)
;
--COMMIT;
--> Error Table:
...
SELECT OOD.OPERATING_UNIT,
 ...
 WHERE 1 = 1 AND OOD.OPERATING_UNIT = OU.ORGANIZATION_ID --AND OPERATING_UNIT=131
...
SELECT *
 ...
 WHERE 1 = 1 AND NAME = 'DBL CL Imported Invoice' AND ORG_ID = 126 AND STATUS='A';
...
SELECT *
 ...
 WHERE 1 = 1 AND NAME = 'Invoice' AND ORG_ID = 131;
...
SELECT INVENTORY_ITEM_ID, segment1
 ...
 WHERE 1 = 1                                        --AND segment1 LIKE 'YRN%'
            AND segment1 = 'YRN06S100CTN52120313' AND ORGANIZATION_ID = 193;
...
IF l_currency_code = 'BDT'
      THEN
         SELECT NULL, NULL, NULL
           INTO L_EXCHANGE_RATE_TYPE, L_EXCHANGE_DATE, L_EXCHANGE_RATE
           FROM DUAL;
      ELSIF l_currency_code != 'BDT' AND P_EXCHANGE_TYPE = 'User'
      THEN
         SELECT P_EXCHANGE_TYPE, P_TRX_DATE, P_EXCHANGE_RATE
           INTO L_EXCHANGE_RATE_TYPE, L_EXCHANGE_DATE, L_EXCHANGE_RATE
           FROM DUAL;
      ELSE
         SELECT CONVERSION_TYPE, CONVERSION_DATE, CONVERSION_RATE
          ...
          WHERE     1 = 1
                ...
                AND TRUNC (CONVERSION_DATE) = TRUNC (P_TRX_DATE)
...
SELECT OOH.*
 ...
 WHERE 1 = 1 AND ORDER_NUMBER = '2011010000120';
...
SELECT *
 ...
 WHERE 1 = 1 AND CUST_TRX_TYPE_ID = '17162';
