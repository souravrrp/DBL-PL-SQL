/* Formatted on 11/7/2020 3:43:38 PM (QP5 v5.287) */
SELECT fcr.request_id,
 ...
 WHERE     fcpt.application_id = fcr.program_application_id
       ...
       AND (   :p_concurrent_program_name is null or (upper (fcpt.user_concurrent_program_name) like upper ('%' || :p_concurrent_program_name || '%')))
       and ( ( :p_parameter is null) or (upper (fcr.argument_text) like upper ('%' || :p_parameter || '%')))
