SELECT cpt.user_concurrent_program_name     "Concurrent Program Name",
 ...
 WHERE rg.request_group_id       =  rgu.request_group_id
   ...
   AND NVL(rg.zd_edition_name,'SET2')  = DECODE(rg.zd_edition_name,'SET1','SET2','SET2')
   AND NVL(fat.zd_edition_name,'SET2') = DECODE(fat.zd_edition_name,'SET1','SET2','SET2')
   AND NVL(fa.zd_edition_name,'SET2')  = DECODE(fa.zd_edition_name,'SET1','SET2','SET2')
   AND NVL(cpt.zd_edition_name,'SET2') = DECODE(cpt.zd_edition_name,'SET1','SET2','SET2')
   AND NVL(cp.zd_edition_name,'SET2')  = DECODE(cp.zd_edition_name,'SET1','SET2','SET2')
   AND NVL(rgu.zd_edition_name,'SET2') = DECODE(rgu.zd_edition_name,'SET1','SET2','SET2')
