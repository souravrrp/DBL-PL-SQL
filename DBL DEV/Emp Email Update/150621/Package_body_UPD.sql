/* Formatted on 6/16/2021 9:17:05 AM (QP5 v5.287) */
CREATE OR REPLACE PACKAGE BODY APPS.xxdbl_employee_update
IS
   PROCEDURE update_emp_email_addess (l_effective_date DATE)
   IS
      ...
      LOOP
         BEGIN
            DECLARE
               ...
               l_person_id                   NUMBER
                                                := cur_upd_email.person_id;
            BEGIN
               hr_person_api.update_person (
                  p_validate                   => FALSE,
                  p_effective_date             => TO_DATE (l_effective_date,
                                                           'DD-MON-YYYY'),
