/* Formatted on 7/25/2021 11:50:49 AM (QP5 v5.287) */
...
BEGIN
   SYS.DBMS_SCHEDULER.create_job (
      ...
      job_action        => 'BEGIN EXECUTE dbms_mview.refresh(''APPS.XXDBL_INV_ITEM_CST_RPT_MV'',method => ''C'',ATOMIC_REFRESH=>FALSE) END;',
