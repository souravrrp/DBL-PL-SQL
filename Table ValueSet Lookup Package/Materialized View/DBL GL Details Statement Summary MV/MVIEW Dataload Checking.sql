...
SELECT *
  FROM APPS.XXDBL_GL_DTL_STAT_SUM_MV#
 --WHERE ROWNUM < 10
 ;
...
SELECT *
  FROM apps.xx_gl_details_statement_v_2
 WHERE     1 = 1
       AND ledger_id = '2095'
       --AND account = '512147'
       AND voucher_date BETWEEN '01-JUL-2020' AND '30-JUN-2021'
...
/* Formatted on 8/3/2021 4:34:20 PM (QP5 v5.287) */
CREATE OR REPLACE FORCE VIEW APPS.XX_GL_DETAILS_STATEMENT_V_2
(
   SL,
   APPLICATION_ID,
   JE_SOURCE,
...
GRANT SELECT ON APPS.XX_GL_DETAILS_STATEMENT_V_2 TO APPSRO;
