/* Formatted on 10/13/2020 3:56:25 PM (QP5 v5.287) */
DECLARE
   vl_set_process_id    NUMBER := TO_CHAR (SYSDATE, 'ddmmyyyy');
   V_catalog_Group_id   NUMBER := 34;
   ...
   IS
      SELECT inventory_item_id v_item_id
       ...
       WHERE     1 = 1
             --AND msi.segment1 IN ('DYES0000000000000038')
             AND msi.segment1 LIKE 'DYES%'
