...
SELECT msi.segment1, msi.inventory_item_id
 ...
 WHERE     1 = 1
       ...
       AND msi.segment1 LIKE 'CHEMI%'
       --AND msi.segment1 IN ( 'CHEMICAL000000000391')
...
WHERE 1=1
AND SEGMENT1='Chemicals'


SELECT *
  FROM mtl_system_items_interface
 WHERE 1 = 1 AND INVENTORY_ITEM_ID = 44645 AND organization_id = 138;
