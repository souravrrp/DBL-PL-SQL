/* Formatted on 11/4/2021 4:25:50 PM (QP5 v5.365) */
DECLARE
    ...
    lr_item_code              VARCHAR2 (20) := 'SPRECONS000000087795';
    lr_item_description       VARCHAR2 (240)
        := 'COPPER AIR TERMINAL CLASS-1 (12MM, 2’ LENGTH) 5';
    ...
    l_user_name               VARCHAR2 (30) := '103908';          -- user name
...
BEGIN
    ...
    FND_GLOBAL.APPS_INITIALIZE (l_user_id, l_resp_id, l_application_id); -- Mfg / Mfg and Dist Mgr / INV
    ...
    lt_item_table (1).description := lr_item_description;
    lt_item_table (1).long_description := lr_item_description;
