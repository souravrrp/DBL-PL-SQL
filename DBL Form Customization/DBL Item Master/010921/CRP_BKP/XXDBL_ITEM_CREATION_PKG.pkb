...
AS
   ...
   BEGIN
      ...
      EXCEPTION
         ...
         THEN
            ...
            INSERT INTO xxdbl_catalog_elem_serial
                        (catalog_group, element_name, last_serial,
                         created_by, creation_date, last_updated_by,
                         last_update_date, last_update_login
                        )
                 VALUES (p_catalog_group, p_element, l_serial_num,
      ...
      SELECT conversion_rate
       ...
       WHERE ucc.from_uom_code =
                (SELECT uomt.uom_code
                   FROM mtl_units_of_measure uom, mtl_units_of_measure uomt
   ...
   BEGIN
      ...
      THEN
         l_stage :=
            SUBSTRB (   'Error in get_ccid api - coa id '
   ...
   EXCEPTION
      ...
      THEN
         x_message :=
            SUBSTRB (   'Unexpected Error in gen_expense_ccid - '
                     || l_stage
                     || ' - '
                     || SQLERRM,
                     1,
   ...
   BEGIN
      ...
      x_message :=
         SUBSTRB (   'Post-call inv_item_category_pub - x_return_status = '
                  || x_return_status
                  || ' x_errorcode = '
                  || x_errorcode
                  || ' x_msg_count = '
      ...
      THEN
         ...
         LOOP
            x_msg_data := oe_msg_pub.get (p_msg_index      => n,
                                          p_encoded        => 'F');
            x_message :=
   ...
   PROCEDURE assign_catalog_elements (
...
------------------------------------------------
   ...
   BEGIN
      ...
      ELSE
         ...
         FOR i IN (SELECT   el.element_name, el.element_desc
   ...
   PROCEDURE create_uom_conversions (
      p_primary_uom_code     IN       VARCHAR2,
      p_secondary_uom_code   IN       VARCHAR2,
   ...
   BEGIN
      ...
      FOR i IN (SELECT uomt.uom_code, uc.conversion_rate
      ...
      FOR j IN (SELECT uomt.uom_code, uc.conversion_rate
                  FROM mtl_units_of_measure uom,
                       mtl_units_of_measure uomt,
                       mtl_uom_conversions uc
                 WHERE uom.uom_code = p_secondary_uom_code
      ...
      ELSE
         ...
         x_message :=
            SUBSTRB (   'API call inv_convert, derived base conv = '
                     || l_base_conv_rate,
                     1,
                     500
                    );
         ...
         writedebug
                   (SUBSTRB (   'Post-call create_uom_conversion api result '
                             || l_return_status,
                             1,
                             500
                            )
         ...
         ELSE
            x_message :=
               SUBSTRB ('create_uom_conversion api result ' || l_return_status,
                        1,
                        1000
                       );
         END IF;
   ...
   IS
      ...
      IS
         SELECT io.organization_id, io.organization_code, io.org_name,
                ioh.item_org_hierarchy_id, ioh.item_master_id,
                ioh.organization_structure_id, ioh.org_hierarchy,
                ioh.template_id, ioh.template_name, ioh.category_set_id,
                ioh.category_id, ioh.category_name, ioh.lead_time,
                ioh.min_quantity, ioh.max_quantity, ioh.rfq_flag,
                ioh.lcm_flag, ioh.routing, ioh.expense_account,
                ioh.expense_sub_account, ioh.product_line
   ...
   BEGIN
      ...
      SELECT organization_id
       ...
       and master_organization_id=138;
         ...
         BEGIN
            ...
            THEN
               ...
               BEGIN
                  SELECT template_id,
                         ...
                         rfq_flag,
                         routing,
                         expense_account, expense_sub_account,
                         product_line, category_id, category_set_id,
                         category_name
                    INTO lt_item_table (1).template_id,
                         ...
                         l_expense_account, l_expense_sub_account,
                         l_product_line, l_category_id, l_category_set_id,
                         l_category_name
               ...
               THEN
                  ROLLBACK TO SAVEPOINT x_loop_start;
                  writedebug (   'API Error Messages for item master id '
                              || r1.item_master_id
                              || ', item code '
                              || r1.item_code
                              || ':'
                  ...
                  LOOP
                     ...
                     writedebug (n || '> ' || x_message_list (n).MESSAGE_TEXT);
                  END LOOP;
               ...
               THEN
                  l_stage :=
                     SUBSTRB (   'Creating master org category '
                              || l_category_name
                              || ' for item '
                              || r1.item_code,
                              1,
                  ...
                  assign_category (p_category_id            => l_category_id,
                  ...
                  l_stage :=
                     SUBSTRB (   'Post-call master org assign category '
                              || l_category_name
                              || ' for item '
                              || r1.item_code,
                              1,
            ...
            ELSE
               BEGIN
                  ...
                  writedebug (   'Existing x_inventory_item_id = '
                              || x_inventory_item_id
                             );
               EXCEPTION
                  WHEN OTHERS
            ...
            l_stage :=
               SUBSTRB (   'API assign_catalog_elements '
                        || r1.item_code
                        || ' item_master_id = '
                        || r1.item_master_id,
                        1,
            ...
            l_stage :=
               SUBSTRB (   'API assign_catalog_elements post-call '
                        || r1.item_code
                        || ' item_master_id = '
                        || r1.item_master_id,
                        1,
            ...
            LOOP
               ...
               ----------
               l_stage :=
                  SUBSTRB (   'Fetching expense account for item '
                           || r1.item_code
                           || ' and org code '
                           || r2.organization_code,
                           1,
               ...
               l_stage :=
                  SUBSTRB (   'API call process_items to org assign item '
                           || r1.item_code
                           || ' for '
                           || r2.organization_code,
                           1,
               ...
               l_stage :=
                  SUBSTRB (   'API post-call process_items to org assign '
                           || r1.item_code
                           || ' for '
                           || r2.organization_code,
                           1,
               ...
               THEN
                  ...
                  assign_category (p_category_id            => r2.category_id,
                  ...
                  l_stage :=
                     SUBSTRB (   'Post-call assign category '
                              || r2.category_name
                              || ' for item '
                              || r1.item_code
                              || ' for org code '
               ...
               THEN
                  FOR j IN
                     (SELECT mcs.default_category_id, mcs.category_set_id
                        FROM mtl_category_sets mcs
                       WHERE mcs.category_set_id =
                                  fnd_profile.VALUE ('INL_ITEM_CATEGORY_SET'))
                  LOOP
                     l_stage :=
                        SUBSTRB (   'Creating LCM category for item '
                                 || r1.item_code
                                 || ' for org code '
                                 || r2.organization_code,
                                 1,
                     ...
                     l_stage :=
                        SUBSTRB (   'Post-call LCM category for item '
                                 || r1.item_code
                                 || ' for org code '
                                 || r2.organization_code,
                                 1,
...
------------
         ...
         EXCEPTION
            ...
            THEN
               ...
               INSERT INTO xxdbl_item_errors
                           (batch_id, item_master_id,
                            item_org_hierarchy_id, organization_id,
                            request_id, error_message,
                            created_by, creation_date, last_updated_by,
                            last_update_date, last_update_login
                           )
                    VALUES (p_batch_id, r1.item_master_id,
                            l_item_org_hierarchy_id, l_organization_id,
                            fnd_global.conc_request_id, l_message,
                            fnd_global.user_id, SYSDATE, fnd_global.user_id,
                            SYSDATE, fnd_global.login_id
                           );
            ...
            THEN
               ROLLBACK TO SAVEPOINT x_loop_start;
               l_message :=
                  SUBSTRB ('Unexpected Error - ' || l_stage || ' - '
                           || SQLERRM,
                           1,
                           4000
                          );
   ...
   BEGIN
      ...
      SELECT xxdbl_item_batch_id_s.NEXTVAL
        INTO x_new_batch_id
        FROM DUAL;
      ...
      INSERT INTO xxdbl_item_batches
                  (batch_id, batch_name, created_by,
                   creation_date, last_updated_by, last_update_date,
                   last_update_login, request_id, batch_status, from_batch_id
                  )
           VALUES (x_new_batch_id, TO_CHAR (x_new_batch_id), l_user_id,
                   l_sysdate, l_user_id, l_sysdate,
                   l_login_id, NULL, 'NEW', p_batch_id
                  );
      ...
      LOOP
         ...
         INSERT INTO xxdbl_item_master
                     (item_master_id, batch_id, created_by, creation_date,
                      last_updated_by, last_update_date, last_update_login,
                      catalog_group_id, catalog_type, item_code,
                      item_description, primary_uom_code,
                      secondary_uom_code, dual_uom_flag,
                      uom_conversion, long_description, item_status,
                      from_master_id, from_batch_id
                     )
              VALUES (l_item_master_id, x_new_batch_id, l_user_id, l_sysdate,
                      l_user_id, l_sysdate, l_login_id,
                      r1.catalog_group_id, r1.catalog_type, r1.item_code,
                      r1.item_description, r1.primary_uom_code,
                      r1.secondary_uom_code, r1.dual_uom_flag,
                      r1.uom_conversion, r1.long_description, 'NEW',
                      r1.item_master_id, p_batch_id
                     );

         FOR r2 IN cur_elements (r1.item_master_id)
         LOOP
            l_stage :=
               SUBSTRB (   'element insert - '
                        || r1.item_code
                        || ', '
                        || r2.element_name,
                        1,
            ...
            INSERT INTO xxdbl_item_code_elements
                        (item_master_id, element_id,
                         catalog_group_id, catalog_group,
                         element_name, value_set_id, value_set_name,
                         element_value, data_type, data_length,
                         created_by, creation_date, last_updated_by,
                         last_update_date, last_update_login, element_desc,
                         default_element_flag
                        )
                 VALUES (l_item_master_id, r2.element_id,
                         r2.catalog_group_id, r2.catalog_group,
                         r2.element_name, r2.value_set_id, r2.value_set_name,
                         r2.element_value, r2.data_type, r2.data_length,
                         l_user_id, l_sysdate, l_user_id,
                         l_sysdate, l_login_id, r2.element_desc,
   ...
   EXCEPTION
      ...
      THEN
         ...
         x_return_status := 'E';
         x_message :=
            SUBSTRB ('Error in copying batch - ' || l_stage || ' - '
                     || SQLERRM,
                     1,
                     500
                    );
