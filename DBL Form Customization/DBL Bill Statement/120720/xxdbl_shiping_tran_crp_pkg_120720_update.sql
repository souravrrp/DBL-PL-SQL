/* Formatted on 7/12/2020 9:34:10 AM (QP5 v5.287) */
         ...
         SELECT COUNT (1)
          ...
          WHERE     1 = 1
                ...
                AND (   (g.NAME LIKE '%Replacement%')
                     OR (g.NAME LIKE '%Return%Order%')); --Updated_12JUL20_ADD_RETURN_ORDERS
      EXCEPTION
         WHEN OTHERS
         THEN
            l_return_order := 0;
         ...
         BEGIN
            SELECT NVL (SUM (quantity), 0)
             ...
             WHERE     xbsl.bill_stat_header_id = xbsh.bill_stat_header_id
                   ...
                   AND xbsl.order_line_no LIKE l_line_number || '.' || '%' /*AND xbsl.order_line_id IN (
                                                                                  SELECT     aa.line_id
