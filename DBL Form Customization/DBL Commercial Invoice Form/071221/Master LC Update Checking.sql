/* Formatted on 12/7/2021 5:39:05 PM (QP5 v5.365) */
SELECT *
  FROM (SELECT DISTINCT
         ...
         WHERE     1 = 1
               ...
               AND xph.proforma_number = 'PI-2026-000217'
        ...
        SELECT DISTINCT
         ...
         WHERE     mlh.master_lc_header_id = mlc.master_lc_header_id
               ...
               AND oola.line_number =
                   REGEXP_SUBSTR (xbsl.order_line_no, '[^.]+')
