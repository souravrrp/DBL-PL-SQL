      ...
      BEGIN
         SELECT COUNT (1)
           ...
           FROM (SELECT DISTINCT sup.organization_id, sup.order_number,
                            ...
                            FROM msc_orders_v@prod_to_ascp sup,
      ...
      THEN
         ...
         LOOP
            ...
            BEGIN
               ...
               --
               -- Update parent order
               UPDATE msc_supplies@prod_to_ascp
...
--
   ...
   FUNCTION get_remainning_quantity (p_order_number IN NUMBER)
      RETURN NUMBER
   IS
   ...
   FUNCTION get_remainning_quantity_wo (
      ...
      p_customer_po_number        VARCHAR2 DEFAULT NULL,
      p_customer_number      IN   VARCHAR2 DEFAULT NULL,
      p_customer_name        IN   VARCHAR2 DEFAULT NULL,
      p_customer_id          IN   NUMBER DEFAULT NULL,
      p_order_number         IN   NUMBER DEFAULT NULL,
   ...
   FUNCTION get_remain_quantity_wo_mto (
      p_transaction_source        VARCHAR2 DEFAULT 'MTO',
      p_lot_number                VARCHAR2 DEFAULT NULL,
      p_customer_po_number        VARCHAR2 DEFAULT NULL,
      p_customer_number      IN   VARCHAR2 DEFAULT NULL,
      p_customer_name        IN   VARCHAR2 DEFAULT NULL,
   ...
   FUNCTION get_remainning_quantity_sec (p_order_number IN NUMBER)
      RETURN NUMBER
   IS
      l_total_quantity        NUMBER := 0;
      l_remainning_quantity   NUMBER := 0;
