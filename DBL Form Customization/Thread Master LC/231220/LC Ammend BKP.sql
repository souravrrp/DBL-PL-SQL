      ...
      THEN
         BEGIN
            SELECT COUNT (1)
             ...
             WHERE attribute4 = :xxdbl_master_lc_headers.master_lc_header_id
         ...
         ELSE
            ...
            ELSE
               ...
               SELECT GREATEST (:xxdbl_master_lc_headers.amd_no, l_amd_no) + 1
               ...
               LOOP
                  ...
                  INSERT INTO xxdbl_master_lc_headers
                              (master_lc_header_id,
                               master_lc_number,
                               master_lc_status,
                               internal_doc_number,
                               ...
                               bin_number, tin_number,
                               irc_number, erc_number,
                       ...
                       VALUES (l_xxdbl_master_lc_headers_s,
                               ...
                               rec_hdr.org_id, rec_hdr.ou_name,
                               rec_hdr.customer_number,
                               rec_hdr.customer_name, rec_hdr.customer_id,
                               rec_hdr.bank_name, rec_hdr.bank_address,
                               rec_hdr.bin_number, rec_hdr.tin_number,
                               rec_hdr.irc_number, rec_hdr.erc_number,
                               rec_hdr.attribute1, rec_hdr.attribute2,
                               rec_hdr.attribute3, rec_hdr.attribute4,
                               rec_hdr.attribute5, rec_hdr.attribute6,
                               rec_hdr.attribute7, rec_hdr.attribute8,
                               rec_hdr.attribute9, rec_hdr.attribute10,
                               rec_hdr.attribute11, rec_hdr.attribute12,
                               rec_hdr.attribute13, rec_hdr.attribute14,
                               rec_hdr.attribute15, rec_hdr.attribute16,
                               rec_hdr.attribute17, rec_hdr.attribute18,
                               rec_hdr.attribute19, rec_hdr.attribute20,
                               l_date, l_user_id,
                               l_date, l_user_id, l_login_id,
                               rec_hdr.lc_expire_number,
                               rec_hdr.lc_expire_date,
                               rec_hdr.lc_shipment_date, rec_hdr.lc_value,
                               rec_hdr.exp_number, rec_hdr.exp_date,
                               rec_hdr.remarks, rec_hdr.amd_no
                              );
                  ...
                  LOOP
                     ...
                     INSERT INTO xxdbl_master_lc_line1
                                 (master_lc_header_id,
                                  master_lc_line1_id,
                                  pi_number, pi_id,
                                  pi_date, pi_currency,
                          ...
                          VALUES (l_xxdbl_master_lc_headers_s,
                                  ...
                                  rec_line1.pi_number, rec_line1.pi_id,
                                  rec_line1.pi_date, rec_line1.pi_currency,
                                  rec_line1.pi_value, rec_line1.attribute1,
                                  rec_line1.attribute2, rec_line1.attribute3,
                                  rec_line1.attribute4, rec_line1.attribute5,
                                  rec_line1.attribute6, rec_line1.attribute7,
                                  rec_line1.attribute8, rec_line1.attribute9,
                                  ...
                                  rec_line1.attribute20, l_date,
                                  l_user_id, l_date, l_user_id,
                                  l_login_id
                                 );
                  ...
                  LOOP
                     ...
                     INSERT INTO xxdbl_master_lc_line2
                                 (master_lc_header_id,
                                  master_lc_line2_id,
                                  lc_number,
                                  master_lc_date,
                          ...
                          VALUES (l_xxdbl_master_lc_headers_s,
                                  ...
                                  rec_line2.bin_number, rec_line2.tin_number,
                                  rec_line2.irc_number, rec_line2.erc_number,
                                  rec_line2.attribute1, rec_line2.attribute2,
                                  rec_line2.attribute3, rec_line2.attribute4,
                                  rec_line2.attribute5, rec_line2.attribute6,
                                  rec_line2.attribute7, rec_line2.attribute8,
                                  ...
                                  rec_line2.attribute20, l_date,
                                  l_user_id, l_date, l_user_id,
                                  l_login_id, rec_line2.buyers_po,
                                  rec_line2.lacf_number, rec_line2.remarks
                                 );
