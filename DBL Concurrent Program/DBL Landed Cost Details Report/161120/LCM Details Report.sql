/* Formatted on 11/16/2020 4:07:34 PM (QP5 v5.354) */
  SELECT a.segment1,
         a.po_header_id,
         a.vendor_name,
         a.approved_date,
    ...
    FROM (SELECT pha.segment1,
           ...
           WHERE     ish.ship_header_id = isl.ship_header_id(+)
                 ...
                 AND (   :p_lc_from_creation_date IS NULL
                      OR TRUNC (lc.creation_date) BETWEEN :p_lc_from_creation_date
                                                      AND :p_lc_to_creation_date)
          UNION ALL
          SELECT po.segment1,
                 po.po_header_id,
                 sup.vendor_name,
