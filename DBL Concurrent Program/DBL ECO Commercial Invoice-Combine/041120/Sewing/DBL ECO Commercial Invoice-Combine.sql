/* Formatted on 11/4/2020 10:09:46 AM (QP5 v5.354) */
WITH
    ...
    AS
        (SELECT ph.customer_number,
          ...
          WHERE     cil.inventory_item_id = mic.inventory_item_id
                ...
                --AND cih.comm_inv_number = 'eco/2019/CI000007'
  ...
  SELECT customer_number,
   ...
   WHERE comm_inv_number = :p_comm_inv_number AND :p_report_type = 'Sewing'
