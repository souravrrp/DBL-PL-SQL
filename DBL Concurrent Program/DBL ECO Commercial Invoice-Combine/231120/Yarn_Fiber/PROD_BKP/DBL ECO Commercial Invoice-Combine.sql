/* Formatted on 11/4/2020 10:06:57 AM (QP5 v5.354) */
WITH
    ...
    AS
        (SELECT ph.customer_number,
                ...
                (CASE
                     ...
                     THEN
                         '100% COTTON YARN (DYED DARK) FIBER DYEING CHARGES'
                     WHEN mic.segment3 = 'DYED YARN'
                     THEN
                         '100% COTTON YARN (DYED DARK) YARN DYEING CHARGES'
                 END)
                    description,
                ...
                (  SELECT master_lc_number,
                     ...
                     FROM (  SELECT mlh.master_lc_number,
                           ...
                           GROUP BY master_lc_number,
                                    ...
                                    mll2.attribute4,
                                    mll2.remarks) tt
                 GROUP BY master_lc_number, amd_no, remarks) lcd
  ...
  SELECT customer_number,
         ...
         ROUND (SUM (line_value), 2)                   line_value,
         bin_number,
         tin_number,
         irc_number,
         erc_number,
   ...
   WHERE comm_inv_number = :p_comm_inv_number AND :p_report_type = 'Yarn_Fiber'
