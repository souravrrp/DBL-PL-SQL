/* Formatted on 6/2/2021 5:12:10 PM (QP5 v5.354) */
SELECT dt.price_list_name,
  ...
  FROM (  SELECT opl.name
                 ...
                 opl.currency_code
                     currency,
                 TO_CHAR (MAX (opll.start_date_active), 'DD-MON-RRRR')
                     effective_date_from,
                 TO_CHAR (MAX (opll.end_date_active), 'DD-MON-RRRR')
                     effective_date_to,
           ...
           WHERE     1 = 1
                 ...
                 --AND opll.concatenated_segments = 'GP3030-010GRD'
