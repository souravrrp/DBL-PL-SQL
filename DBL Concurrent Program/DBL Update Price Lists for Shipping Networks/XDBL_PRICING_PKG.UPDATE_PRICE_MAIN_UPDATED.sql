/* Formatted on 7/18/2020 1:54:07 PM (QP5 v5.287) */
           ...
           SELECT x.org_id,
                  ...
                  NVL (
                     ...
                     XXDBL.xxdbl_fnc_get_item_cost (
                        ...
                        x.item_id,
                        TO_CHAR (cp_approve_date, 'MON-YY')))
                     unit_price,
                  x.uom_code,
   ...
   BEGIN
      ...
      LOOP
         ...
         LOOP
            ...
            writelog (
                  'Price list line for price list '
               || r2.pricelist_name
               || '; pricelist id '
               || r2.pricelist_id
               || '; item  '
               ...
               */
               ...
               THEN
                  ...
                  LOOP
                     ...
                     writelog (
                           'UPDATE MODE: pricing_attribute_id = '
                        || n.pricing_attribute_id);
                     EXIT;
                  END LOOP;
               END IF;
               ...
               gpr_pricing_attr_tbl (j).operation :=
                  gpr_price_list_line_tbl (k).operation;
               writelog (
                     'Calling qp_price_list_pub API for price list '
                  || r2.pricelist_name
                  || '; item id '
                  || r1.item_id
                  || ', inv org id '
               ...
               ELSE
                  writelog (
                        'Price List updated successfully , added lines '
