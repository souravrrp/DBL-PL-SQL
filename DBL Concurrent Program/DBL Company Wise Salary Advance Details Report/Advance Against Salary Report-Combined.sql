/* Formatted on 1/27/2020 10:07:48 AM (QP5 v5.287) */
  SELECT employee_number,
         employee_name,
         TO_CHAR ( :p_date_from) from_date,
         null date_to,
         TO_CHAR ( :p_date_from, 'MON-YY') payroll_month,
    ...
    FROM (SELECT papf.employee_number,
           ...
           WHERE     1 = 1
                 ...
                 AND TO_CHAR (peevf.effective_start_date, 'MON-YY') <=
                        TO_CHAR ( :p_date_from, 'MON-YY')
          ...
          SELECT DISTINCT
           ...
           WHERE                                   -- pca.segment5 = '1060103'
                papf .person_id = paaf.person_id
                 ...
                 AND TO_CHAR (ppa.effective_date, 'MON-YY') <=
                        TO_CHAR ( :p_date_from, 'MON-YY')
