/* Formatted on 2/6/2022 4:29:28 PM (QP5 v5.374) */
SELECT ac.customer_number,
 ...
 WHERE     oha.header_id = ola.header_id
       ...
       AND col.organization_id = cat.organization_id
...
SELECT ac.customer_number,
       ...
       * ola.unit_selling_price
       / (CASE
              ...
              WHEN cay.segment3 IN ('DYED FIBER', 'DYED YARN')
              THEN
                  (100 / (100 - ola.cust_model_serial_number) * (ola.ordered_quantity))
          END)
           unit_list_price,
       ola.unit_selling_price,
       ...
       ola.shipped_quantity * (-1)
           traget_qty,
       ola.shipped_quantity2 * (-1)
           shipped_quantity2,
       (ola.shipped_quantity * (-1)) * ola.unit_selling_price
           invoice_amount,
       ctl.revenue_amount,
       ct.exchange_rate,
       ctl.revenue_amount * ct.exchange_rate
           revenue_amount_bdt,
       ct.trx_number
           invoice_number,
       NULL
