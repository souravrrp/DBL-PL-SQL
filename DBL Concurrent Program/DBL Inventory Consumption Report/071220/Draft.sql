/* Formatted on 12/7/2020 4:55:48 PM (QP5 v5.354) */
SELECT '1.MOVE_ORDER'
           AS TR_SOURCE,
       'Move_Order'
           TR_TYPE,
       ...
       || (SELECT DESCRIPTION
             FROM FND_FLEX_VALUES_VL
            WHERE FLEX_VALUE_SET_ID = 1017029 AND FLEX_VALUE = CC.SEGMENT2)
           LOCATION_DESC,
          CC.SEGMENT3
       || ' - '
       || (SELECT DESCRIPTION
       ...
       || (SELECT DESCRIPTION
             FROM FND_FLEX_VALUES_VL
            WHERE FLEX_VALUE_SET_ID = 1017036 AND FLEX_VALUE = CC.SEGMENT7)
           INTER_COMPANY,
          CC.SEGMENT8
       || ' - '
       || (SELECT DESCRIPTION
 ...
 WHERE     A.ORGANIZATION_ID = MP.ORGANIZATION_ID
       ...
       AND A.TRANSACTION_TYPE_ID IN (63,42)
       ...
       AND TRUNC (A.TRANSACTION_DATE) BETWEEN :P_DATE_FROM AND :P_DATE_TO
       AND C.SEGMENT1 IN ('SPRECONS000000007079');