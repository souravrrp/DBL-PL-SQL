/* Formatted on 6/7/2021 9:55:37 AM (QP5 v5.354) */
SELECT ORGANIZATION_NAME,
       ...
       || (SELECT DESCRIPTION
            ...
            WHERE     FLEX_VALUE_SET_ID = 1017040
                  AND FLEX_VALUE = NATURAL_ACCOUNT_DESC)
           NATURAL_ACCOUNT_DESC,
          SUB_ACCCOUNT_DESC
       || ' - '
       || (SELECT DESCRIPTION
            ...
            WHERE FLEX_VALUE_ID =
                  (SELECT FLEX_VALUE_ID
                    ...
                    WHERE     FLEX_VALUE_SET_ID =
                          ...
                          AND FLEX_VALUE = SUB_ACCCOUNT_DESC
                          AND PARENT_FLEX_VALUE_LOW =
                              (SELECT FLEX_VALUE
                                 FROM FND_FLEX_VALUES_VL B
                                WHERE     FLEX_VALUE_SET_ID = 1017040
                                      AND B.FLEX_VALUE = NATURAL_ACCOUNT_DESC)))
           SUB_ACCCOUNT_DESC,
       INTER_COMPANY,
       EXP_CATEGORY_DESC,
       CODE_COMBINATION,
