/* Formatted on 12/8/2020 11:19:32 AM (QP5 v5.354) */
SELECT ORGANIZATION_NAME,
  ...
  FROM (SELECT '1.MOVE_ORDER'
        ...
        SELECT '3.DIS_ACC_ALS'
               ...
               TRUNC (A.TRANSACTION_DATE)
                   TRANSACTION_DATE,
               TO_CHAR (TRUNC (A.TRANSACTION_DATE), 'MON-YY')
                   PERIOD_NAME,
               'prduction_use'
                   AS "Use_Area",
                  CC.SEGMENT1
