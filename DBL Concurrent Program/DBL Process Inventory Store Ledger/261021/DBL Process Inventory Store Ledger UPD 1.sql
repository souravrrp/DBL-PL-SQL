/* Formatted on 10/9/2021 3:22:50 PM (QP5 v5.365) */
WITH
    MAINS
    AS
...
SELECT M.ORGANIZATION_ID,
       ...
       ROUND ((T.ISU_VAL / DECODE (T.ISU_QTY, 0, 1, T.ISU_QTY)), 2)
           AVG_ISS_VAL,
       ROUND (
             DECODE (T.AVL_VAL, 0, 1, T.AVL_VAL)
           / DECODE ((NVL (T.OPN_QTY, 0) + NVL (T.RCV_QTY, 0)),
                     0, 1,
                     (NVL (T.OPN_QTY, 0) + NVL (T.RCV_QTY, 0))),
           2)
           AVG_COST_AVA_STOCK
