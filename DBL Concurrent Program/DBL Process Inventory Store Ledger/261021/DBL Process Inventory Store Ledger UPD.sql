/* Formatted on 10/28/2021 9:48:40 AM (QP5 v5.365) */
WITH
    MAINS
    AS
...
SELECT M.ORGANIZATION_ID,
       ...
       ROUND (
           ...
           2)                                            AVG_ISS_VAL,
       ROUND (
             DECODE ((T.OPN_VAL + T.RCV_VAL), 0, 1, (T.OPN_VAL + T.RCV_VAL))
           / DECODE ((NVL (T.OPN_QTY, 1) + NVL (T.RCV_QTY, 1)),
                     0, 1,
