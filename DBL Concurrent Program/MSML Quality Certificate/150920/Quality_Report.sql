/* Formatted on 1/7/2020 9:41:38 AM (QP5 v5.287) */
  SELECT ROWNUM SL_NO,
         ...
         PHA.SEGMENT1 REQ_PO_NUMBER,
         PHA.CREATION_DATE REQ_PO_DATE,
   ...
   WHERE     PHA.PO_HEADER_ID = PLA.PO_HEADER_ID
         ...
         AND RT.ORGANIZATION_ID = ORG.ORGANIZATION_ID
...
/* Formatted on 1/7/2020 9:41:38 AM (QP5 v5.287) */
  SELECT ROWNUM SL_NO,
         ...
         RSH.ATTRIBUTE3 CHALLAN_NO,
         RSH.ATTRIBUTE5 SECTION,
         SUM (NVL(PROL.QUANTITY,NVL(RT.QUANTITY,0))) QUANTITY,
         ( :TO_WHOM) "TO_WHOM",
         RT.UOM_CODE UNIT,
         (CASE
             WHEN RT.TRANSACTION_TYPE = 'ACCEPT'
             THEN
                SUM (NVL(PROL.QUANTITY,NVL(RT.QUANTITY,0)))
          END)
            ACCEPTED_QUANTITY,
         (CASE
             WHEN RT.TRANSACTION_TYPE = 'REJECT'
