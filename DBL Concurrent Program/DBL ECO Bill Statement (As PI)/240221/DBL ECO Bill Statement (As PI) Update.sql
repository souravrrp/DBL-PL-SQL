/* Formatted on 2/20/2021 5:14:20 PM (QP5 v5.354) */
  SELECT bsh.customer_number,
         ...
         bsl.attribute2
             hs_code,
         LISTAGG (oha.attribute4, ',') WITHIN GROUP (ORDER BY oha.attribute4)
             AS m_name,
         ...
         :bank_name
             AS bank_name,
         LISTAGG (bsl.attribute1, ',') WITHIN GROUP (ORDER BY bsl.attribute1)
             AS style
