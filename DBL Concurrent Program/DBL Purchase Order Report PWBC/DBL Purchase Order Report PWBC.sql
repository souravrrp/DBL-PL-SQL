/* Formatted on 9/23/2020 2:26:49 PM (QP5 v5.287) */
  SELECT    NVL (pha.attribute1, 'L')
         ...
         dbms_lob.substr( dlt.long_text, 4000, 1) terms_and_condition
   ...
   WHERE     pha.po_header_id = pla.po_header_id
         ...
         AND pha.po_header_id=adf.pk1_value(+)
