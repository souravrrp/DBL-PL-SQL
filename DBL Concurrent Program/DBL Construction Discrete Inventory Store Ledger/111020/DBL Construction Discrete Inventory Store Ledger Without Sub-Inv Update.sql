/* Formatted on 10/11/2020 3:55:39 PM (QP5 v5.354) */
WITH
    MAINS
    AS
             ...
             FROM (       --------------------------PO_RECEIPT----------------
                     SELECT MMT.ORGANIZATION_ID,
                            ...
                            ABS (
                                ...
                                * AVG (MMT.ACTUAL_COST))    PO_RCV_VAL,
                   ...
                   UNION ALL ---------INTRANSIT_SHIPMENT+INTER_ORG_TRNS---------
                     SELECT MMT.ORGANIZATION_ID,
                            ...
                            ABS (
                                  SUM (MMT.PRIMARY_QUANTITY)
                                * AVG (MMT.ACTUAL_COST))    INT_ORG_RCV_VAL,
                            TO_NUMBER (0)                   SUB_INV_RCV_QTY,
                            TO_NUMBER (0)                   SUB_INV_RCV_VAL
                       FROM MTL_MATERIAL_TRANSACTIONS MMT
                      WHERE     (   :P_ORG_ID IS NULL
                   ...
                   UNION ALL --------------------------SUB_INV_TRNS------------
                     SELECT MMT.ORGANIZATION_ID,
                            ...
                            ABS (
                                  SUM (MMT.PRIMARY_QUANTITY)
                                * AVG (MMT.ACTUAL_COST))    SUB_INV_RCV_VAL
                       FROM MTL_MATERIAL_TRANSACTIONS MMT
                      WHERE     (   :P_ORG_ID IS NULL
                                 OR MMT.ORGANIZATION_ID = :P_ORG_ID)
                            AND (   :P_ITEM_ID IS NULL
    ...
    AS
        (  SELECT ORGANIZATION_ID,
                  ...
                  (SUM (MSC_RCV_QTY) + SUM (MO_ISU_QTY))     MO_ISU_QTY,
                  ...
                  -(SUM (MSC_RCV_VAL) + SUM (MO_ISU_VAL))    MO_ISU_VAL,
             ...
             FROM (       --------------------------MOVE_ORD_ISSUE------------
                     SELECT MMT.ORGANIZATION_ID,
                            ...
                            ABS (
                                  SUM (MMT.PRIMARY_QUANTITY)
                                * AVG (MMT.ACTUAL_COST))    MO_ISU_VAL,
                   ...
                   UNION ALL ---------INTRANSIT_SHIPMENT+INTER_ORG_TRNS---------
                     SELECT MMT.ORGANIZATION_ID,
                            ...
                            ABS (
                                  SUM (MMT.PRIMARY_QUANTITY)
                                * AVG (MMT.ACTUAL_COST))    INT_ORG_ISU_VAL,
                            TO_NUMBER (0)                   SUB_INV_ISU_QTY,
                            TO_NUMBER (0)                   SUB_INV_ISU_VAL,
                            TO_NUMBER (0)                   RTN_ISU_QTY,
                            TO_NUMBER (0)                   RTN_ISU_VAL,
                   ...
                   UNION ALL --------------------------SUB_INV_TRNS------------
                     SELECT MMT.ORGANIZATION_ID,
                            ...
                            ABS (
                                  SUM (MMT.PRIMARY_QUANTITY)
                                * AVG (MMT.ACTUAL_COST))    SUB_INV_ISU_VAL,
                            TO_NUMBER (0)                   RTN_ISU_QTY,
                            TO_NUMBER (0)                   RTN_ISU_VAL,
                            TO_NUMBER (0)                   MSC_RCV_QTY,
                            TO_NUMBER (0)                   MSC_RCV_VAL
                   ...
                   UNION ALL --------------------------RETURN_TO_VENDOR-----------
                     SELECT MMT.ORGANIZATION_ID,
                            ...
                            ABS (
                                  SUM (MMT.PRIMARY_QUANTITY)
                                * AVG (MMT.ACTUAL_COST))    RTN_ISU_VAL,
                            TO_NUMBER (0)                   MSC_RCV_QTY,
                            TO_NUMBER (0)                   MSC_RCV_VAL
                       FROM MTL_MATERIAL_TRANSACTIONS MMT
                      WHERE     (   :P_ORG_ID IS NULL
                   ...
                   UNION ALL --------------MISCELLANEOUS_RECEIPT----------------
                     SELECT MMT.ORGANIZATION_ID,
                            ...
                            ABS (
                                  SUM (MMT.PRIMARY_QUANTITY)
                                * AVG (MMT.ACTUAL_COST))    MSC_RCV_VAL
                       FROM MTL_MATERIAL_TRANSACTIONS MMT
                      WHERE     (   :P_ORG_ID IS NULL
                                 OR MMT.ORGANIZATION_ID = :P_ORG_ID)
                            AND (   :P_ITEM_ID IS NULL
