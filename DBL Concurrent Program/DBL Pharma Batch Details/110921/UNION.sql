/* Formatted on 9/19/2021 9:25:00 AM (QP5 v5.354) */
SELECT BATCH_ID,
       BATCH_NO,
       LOT_NUMBER,
       PRODUCT,
  ...
  FROM (WITH
            ...
            AS
                (  SELECT BATCH_ID              BATCH_ID_1,
                     ...
                     FROM (SELECT gbh.BATCH_ID,
                                  gbh.batch_no,
                                  APPSRO.GET_SFG_PRO_LOT_IN_ING (gbh.BATCH_ID)
                                      AS created_lot,
                                  mtlot.LOT_NUMBER,
                                  itm.SEGMENT1
                                      ITEM_CODE,
  ...
  FROM (WITH
            ...
            AS
                (  SELECT BATCH_ID              BATCH_ID_1,
                     ...
                     FROM (SELECT gbh.BATCH_ID,
                                  gbh.batch_no,
                                  APPSRO.GET_BULK_PRO_LOT_IN_ING (gbh.BATCH_ID)
                                      AS created_lot,
                                  mtlot.LOT_NUMBER,
                                  itm.SEGMENT1
                                      ITEM_CODE,
...
ORDER BY BATCH_NO, BATCH_NO_1, LOT_NUMBER