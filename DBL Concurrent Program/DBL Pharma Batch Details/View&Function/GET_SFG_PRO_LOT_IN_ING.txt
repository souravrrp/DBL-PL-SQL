CREATE OR REPLACE function APPS.GET_SFG_PRO_LOT_IN_ING(P_BATCH_ID IN NUMBER) return NVARCHAR2 is
...
SELECT 
 ...
 --SELECT APPS.GET_SFG_PRO_LOT_IN_ING(:P_BATCH_ID) FROM DUAL;--638328
/
