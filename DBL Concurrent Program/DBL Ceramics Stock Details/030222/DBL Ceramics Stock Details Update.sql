/* Formatted on 2/5/2022 9:29:20 AM (QP5 v5.374) */
  SELECT                                                        ---    ORG_ID,
         item_code,
         item_description,
         -- P_UOM,
         ...
         (  NVL (SUM (rcv_qty_misc_p), 0)
          ...
          + NVL (SUM (rcv_qty_misc_ppp), 0) --+ NVL (SUM (short_excess_rcv_p), 0)
                                           )
             rcvq_misc_p,
         (  NVL (SUM (rcv_qty_misc_s), 0)
          + NVL (SUM (rcv_qty_misc_ss), 0)
          + NVL (SUM (rcv_qty_misc_sss), 0) --+ NVL (SUM (short_excess_rcv_s), 0)
                                           )
             rcvq_misc_s,
           (  NVL (SUM (rcv_qty_misc_p), 0)
            + NVL (SUM (rcv_qty_misc_pp), 0)
