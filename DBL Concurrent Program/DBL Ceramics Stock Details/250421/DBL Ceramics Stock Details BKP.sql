/* Formatted on 3/2/2021 4:44:29 PM (QP5 v5.354) */
  SELECT                                                        ---    ORG_ID,
         item_code,
         item_description,
         -- P_UOM,
         ...
         (  NVL (SUM (rcv_qty_misc_p), 0)
          ...
          + NVL (SUM (rcv_qty_misc_ppp), 0))                   rcvq_misc_p,
         (  NVL (SUM (rcv_qty_misc_s), 0)
          + NVL (SUM (rcv_qty_misc_ss), 0)
          + NVL (SUM (rcv_qty_misc_sss), 0))                   rcvq_misc_s,
           (  NVL (SUM (rcv_qty_misc_p), 0)
            + NVL (SUM (rcv_qty_misc_pp), 0)
            + NVL (SUM (rcv_qty_misc_ppp), 0))
         * 0.092936803                                    rcvq_misc_sqm,
         ...
         NVL (SUM (wip_issue_p), 0)                       wip_issue_p,
         NVL (SUM (wip_issue_s), 0)                       wip_issue_s,
         NVL (SUM (wip_issue_p), 0) * 0.092936803         wip_issue_m,
         ...
         (NVL (SUM (issu_qty_misc_p), 0)
            + NVL (SUM (wip_issue_p), 0))                   puom_misc_issu,
         (NVL (SUM (issu_qty_misc_s), 0) 
          + NVL (SUM (wip_issue_s), 0))                   suom_misc_issu,
        (NVL (SUM (issu_qty_misc_p), 0)
            + NVL (SUM (wip_issue_p), 0)) * 0.092936803     muom_misc_issu,
         ...
         NVL (SUM (write_off_qty_p), 0)                   puom_write_off,
         NVL (SUM (write_off_qty_s), 0)                   suom_write_off,
         NVL (SUM (write_off_qty_p), 0) * 0.092936803     muom_write_off,
         ...
         (  NVL (SUM (open_bal_p), 0)
          ...
          + NVL (SUM (write_off_qty_p), 0))               puom_cpbal,
         (  NVL (SUM (open_bal_s), 0)
          ...
          + NVL (SUM (write_off_qty_s), 0))               suom_cpbal,
           (  NVL (SUM (open_bal_p), 0)
            + NVL (SUM (rcv_qty_prod_p), 0)
            + NVL (SUM (rcv_qty_misc_p), 0)
            + NVL (SUM (rcv_qty_misc_pp), 0)
