/* Formatted on 9/10/2020 1:12:52 PM (QP5 v5.354) */
  SELECT                                                        ---    ORG_ID,
         item_code,
         item_description,
         -- P_UOM,
    ...
    FROM (SELECT ood.organization_code,
                 ...
                 CASE SIGN (mtln.transaction_date - :p_date_from)
                     ...
                     ELSE
                         CASE 
                             WHEN mmt.transaction_type_id IN (17,44) THEN mtln.primary_quantity
                             ELSE 0
                         END
                 END                             rcv_qty_prod_p,
                 CASE SIGN (mtln.transaction_date - :p_date_from)
                     ...
                     ELSE
                         CASE 
                             WHEN mmt.transaction_type_id IN (17,44) THEN mtln.secondary_transaction_quantity
                             ELSE 0
                         END
                 END                             rcv_qty_prod_s,
                 CASE SIGN (mtln.transaction_date - :p_date_from)
