/* Formatted on 7/25/2020 1:24:46 PM (QP5 v5.287) */
------------------------All Invoice---------------------------------------------
SELECT DISTINCT ac.customer_number,
       ac.customer_name,
 ...
 WHERE     oha.header_id = ola.header_id
       ...
       AND (ola.flow_status_code = 'CLOSED'
            OR olv.omshipping_line_status NOT IN
                  ('CONFIRMED', 'CANCELLED', 'NEW'))
       ...
       AND TRUNC (ola.actual_shipment_date) BETWEEN :p_date_from AND :p_date_to
