/* Formatted on 10/19/2020 10:33:06 AM (QP5 v5.287) */
...
IS
   ...
   IS
      ...
      l_file_id       NUMBER;
      v_document_id   CLOB;
      v_role_name     VARCHAR2 (100) := 'Notification to Buyer';
      v_role_email    VARCHAR2 (100) := 'souravpaulcse@gmail.com';
      n_count_role    INTEGER := 0;
      l_sender        VARCHAR2 (100) := 'Oracle Purchasing';
         ...
         BEGIN
            ...
            THEN
               wf_directory.createadhocrole (
                  ...
                  email_address             => v_role_email, --cur_rec_name.email,
                  status                    => 'ACTIVE',
