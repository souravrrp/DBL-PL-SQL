/* Formatted on 10/6/2020 11:22:48 AM (QP5 v5.287) */
...
IS
   ...
   IS
      ...
      l_itemkey       VARCHAR2 (20)
                         := APPS.XXDBLREQAPPSEQ_S.NEXTVAL || '-XXTEST'; --this should be unique
   ...
   BEGIN
      ...
      */
      ...
      -----------------------------------------------------------------------
      v_document_id :=
         'PLSQL:XXDBL_CUSTOM_WORKFLOW.XXDBL_CREATE_WF_DOC/' || l_itemkey;
