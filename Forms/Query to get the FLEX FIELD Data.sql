/* Formatted on 11/7/2020 12:59:22 PM (QP5 v5.354) */
  SELECT FDFT.TITLE, FDFCU.*, FDF.*
    FROM APPS.FND_DESCRIPTIVE_FLEXS       FDF,
         APPS.FND_DESCRIPTIVE_FLEXS_TL    FDFT,
         APPS.FND_DESCR_FLEX_COLUMN_USAGES FDFCU
   WHERE     FDF.APPLICATION_TABLE_NAME =
             NVL (UPPER ( :P_TABLE_NAME), FDF.APPLICATION_TABLE_NAME)
