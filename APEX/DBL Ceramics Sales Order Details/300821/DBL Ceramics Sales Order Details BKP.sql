/* Formatted on 28/Aug/21 5:10:32 PM (QP5 v5.227.12220.39754) */
  SELECT AC.CUSTOMER_NUMBER,
    ...
    FROM APPS.OE_ORDER_HEADERS_ALL OHA,
         ...
         APPS.MTL_ITEM_CATEGORIES_V CAY,
         APPS.JTF_RS_SALESREPS SAL,
         APPS.JTF_RS_DEFRESOURCES_V RSV,
         APPS.XXDBL_COMPANY_LE_MAPPING_V CLM
   WHERE     OHA.HEADER_ID = OLA.HEADER_ID
         ...
         AND OHA.ORG_ID = 126
         --AND OHA.ORG_ID = :P3_ORG_ID
         AND (   :P3_PRODUCT_CATEGORY IS NULL
              OR CAT.CATEGORY_CONCAT_SEGS = :P3_PRODUCT_CATEGORY)
         AND (:P3_PRODUCT_TYPE IS NULL OR CAY.SEGMENT3 = :P3_PRODUCT_TYPE)
         AND (:P3_ITEM_GRADE IS NULL OR OLA.PREFERRED_GRADE = :P3_ITEM_GRADE)
         AND (   :P3_CUSTOMER_CATEGORY IS NULL
              OR AC.CUSTOMER_CATEGORY_CODE = :P3_CUSTOMER_CATEGORY)
         AND (:P3_SALES_PERSON IS NULL OR OHA.SALESREP_ID = :P3_SALES_PERSON)
         AND (:P3_CUSTOMER_ID IS NULL OR AC.CUSTOMER_ID = :P3_CUSTOMER_ID)
