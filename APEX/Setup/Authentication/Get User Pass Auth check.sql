/* Formatted on 5/18/2021 2:36:38 PM (QP5 v5.287) */
CREATE OR REPLACE FUNCTION apex_fnd_user_check (p_username   IN VARCHAR2,
...
BEGIN
   -- Call the function
   result := apex_fnd_user_check('101012','AzizuL01');
   DBMS_OUTPUT.put_line ('Result: ' || result);
END;


SELECT USERTABLE.USER_NAME, (SELECT apps.test_package12.decrypt (UPPER ('appsrpc999'), usertable.encrypted_user_password)
