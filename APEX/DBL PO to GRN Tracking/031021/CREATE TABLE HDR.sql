/* Formatted on 10/4/2021 3:15:56 PM (QP5 v5.365) */
CREATE TABLE XX_APEX.XXAPEX_PO_GRN_HDR
(
    PO_GRN_TRACK_ID      INTEGER
...
GRANT ALTER, SELECT ON XX_APEX.XXAPEX_PO_GRN_HDR TO APPS WITH GRANT OPTION;

GRANT INSERT, SELECT, UPDATE, DELETE ON XX_APEX.XXAPEX_PO_GRN_HDR TO APPSDBL;
