/* Formatted on 10/3/2021 10:20:42 AM (QP5 v5.365) */
CREATE TABLE XX_APEX.XXAPEX_PO_GRN_DTL
(
    ...
    CONSTRAINT PO_GRN_DTL_FK FOREIGN KEY (PO_GRN_TRACK_ID)
        REFERENCES XXAPEX_PO_GRN_HDR (PO_GRN_TRACK_ID)
);
...
DROP TABLE XX_APEX.XXAPEX_OM_GRN_TRACK_DTL;