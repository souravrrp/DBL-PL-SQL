    ...
    AS
        (SELECT MSIK.ORGANIZATION_ID,
          ...
          WHERE     MSIK.ORGANIZATION_ID = MIC.ORGANIZATION_ID
                ...
                AND ( :P2_ORG_ID IS NULL OR MSIK.ORGANIZATION_ID = :P2_ORG_ID)
                AND (   :P2_ITEM_ID IS NULL
                     OR MSIK.INVENTORY_ITEM_ID = :P2_ITEM_ID)
                AND ( :P2_MJR_CAT IS NULL OR MIC.SEGMENT2 = :P2_MJR_CAT)
                AND ( :P2_MNR_CAT IS NULL OR MIC.SEGMENT3 = :P2_MNR_CAT)),
    TRANS
    AS
        (  SELECT ORGANIZATION_ID,
             ...
             FROM (  SELECT ORGANIZATION_ID,
                       ...
                       FROM (  SELECT MMT.ORGANIZATION_ID,
                                ...
                                WHERE     (   :P2_ORG_ID IS NULL
                                           OR MMT.ORGANIZATION_ID = :P2_ORG_ID)
                                      AND (   :P2_ITEM_ID IS NULL
                                           OR MMT.INVENTORY_ITEM_ID = :P2_ITEM_ID)
                                      AND TRUNC (MMT.TRANSACTION_DATE) < :P2_DATE_FR
                               ...
                               SELECT MMT.ORGANIZATION_ID,
                                ...
                                WHERE     (   :P2_ORG_ID IS NULL
                                      ...
                                      AND MMT.TRANSACTION_TYPE_ID NOT IN (80,
                                                                          ...
                                                                          64,
                                                                          2)
                                      AND TRUNC (MMT.TRANSACTION_DATE) BETWEEN :P2_DATE_FR
                                                                           AND   :P2_DATE_TO
                                                                               + .99999
