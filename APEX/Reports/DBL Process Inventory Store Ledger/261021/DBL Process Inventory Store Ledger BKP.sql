    ...
    AS
        (SELECT MSIK.ORGANIZATION_ID,
          ...
          WHERE     MSIK.ORGANIZATION_ID = MIC.ORGANIZATION_ID
                ...
                AND (   :P4_LEGAL_ENTITY IS NULL
                     OR OOD.LEGAL_ENTITY = :P4_LEGAL_ENTITY)
                AND ( :P4_ORG_ID IS NULL OR MSIK.ORGANIZATION_ID = :P4_ORG_ID)
                AND (   :P4_ITEM_CODE IS NULL
                     OR MSIK.INVENTORY_ITEM_ID = :P4_ITEM_CODE)
                AND ( :P4_MJR_CAT IS NULL OR MIC.SEGMENT2 = :P4_MJR_CAT)
                AND ( :P4_MNR_CAT IS NULL OR MIC.SEGMENT3 = :P4_MNR_CAT)),
    TRANS
    AS
        (  SELECT ORGANIZATION_ID,
             ...
             FROM (  SELECT ORGANIZATION_ID,
                       ...
                       FROM (  SELECT MMT.ORGANIZATION_ID,
                                ...
                                WHERE     (   :P4_ORG_ID IS NULL
                                           OR MMT.ORGANIZATION_ID = :P4_ORG_ID)
                                      AND (   :P4_ITEM_ID IS NULL
                                           OR MMT.INVENTORY_ITEM_ID = :P4_ITEM_ID)
                                      AND TRUNC (MMT.TRANSACTION_DATE) <
                                          TO_DATE ( :P4_DATE_FR, 'MM/DD/YYYY')
                               ...
                               SELECT MMT.ORGANIZATION_ID,
                                ...
                                WHERE     (   :P4_ORG_ID IS NULL
                                      ...
                                      AND MMT.TRANSACTION_TYPE_ID NOT IN (80,
                                                                          ...
                                                                          64,
                                                                          2)
                                      AND TRUNC (MMT.TRANSACTION_DATE) BETWEEN TO_DATE (
                                                                                   :P4_DATE_FR,
                                                                                   'MM/DD/YYYY')
                                                                           AND   TO_DATE (
                                                                                     :P4_DATE_TO,
