...
WHERE 1=1
AND PO_NUMBER='21113004403'
--AND RECEIPT_NUM='21112102491'
AND REQUISITION_NUMBER='21111003563'
--AND PTP.LC_NUMBER='DPCDAK964721'   
--and rownum<=2
;
...
--------------------------------------------------------------------------------
  ...
  SELECT OU_NAME,
   ...
   WHERE     ( :P_LEGAL IS NULL OR LEGAL_ENTITY_ID = :P_LEGAL)
         ...
         AND ( :P_PO_CREATED_BY IS NULL OR PO_CREATED_BY = :P_PO_CREATED_BY)
