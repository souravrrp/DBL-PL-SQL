...
SELECT ORG_ID,
 ...
 WHERE     1 = 1
       AND TRUNC (PR_APPROVED_DATE) BETWEEN :P_DATE_FROM AND :P_DATE_TO
...
UNION ALL
  SELECT OU.ORG_ID,
         ...
         MIC.SEGMENT2 ITEM_CATEGORY_1,
         MIC.SEGMENT3 ITEM_CATEGORY_2,
         MIC.SEGMENT4 ITEM_CATEGORY_3,
         MIC.SEGMENT5 ITEM_CATEGORY_4,
   ...
   WHERE     1 = 1
         ...
         AND MIC.SEGMENT2 = 'IT'
         AND TRUNC (MOQ.TRANSACTION_DATE) BETWEEN :P_DATE_FROM AND :P_DATE_TO
