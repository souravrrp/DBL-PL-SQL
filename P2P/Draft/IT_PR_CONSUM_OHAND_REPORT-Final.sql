...
SELECT
       ...
       TO_CHAR(TRANSACTION_DATE) MONTH_NAME
FROM
(SELECT ORG_ID,
       OU_NAME,
       ...
       NULL ONHAND_QTY,
       TO_CHAR (GRN_DATE, 'MON-RR') TRANSACTION_DATE,
       NULL QTY,
       NULL TOTAL_COST--,
       --TO_CHAR (GRN_DATE, 'MON-RR') MONTH_NAME
...
SELECT CON.ORG_ID,
       ...
       UOM,
       NULL ONHAND_QTY,
       TO_CHAR (TRANSACTION_DATE, 'MON-RR') TRANSACTION_DATE,
       TRX_QUANTITY QTY,
       TOTAL_COST--,
       --TO_CHAR (TRANSACTION_DATE, 'MON-RR') MONTH_NAME
...
GROUP BY OU.ORG_ID,
         ...
         TO_CHAR (TRANSACTION_DATE, 'MON-RR')
