/* Formatted on 2/10/2021 4:17:51 PM (QP5 v5.287) */
...
(TESTED ON VISION 11.5.9 JAN-2007 ) */
  ...
  SELECT SUBSTR (FST.ID_FLEX_STRUCTURE_CODE, 1, 2) "BOOK",
         GAB.NAME "ALLOCATION NAME" /*, (CASE WHEN GAFL.LINE_NUMBER = 1 THEN  GAB.NAME  ELSE NULL END )"ALLOCATION NAME"
...
(TESTED ON VISION 11.5.10.2  JUNE 2007 ) */
  ...
  SELECT SOB.SHORT_NAME "BOOK",
   ...
   WHERE SOB.SET_OF_BOOKS_ID(+) = GLI.SET_OF_BOOKS_ID --AND GLI.WARNING_CODE IS NOT NULL
...
(TESTED ON VISION 11.5.10.2  JUNE 2007 ) */
  ...
  SELECT SOB.SHORT_NAME "BOOK NAME",
         ...
         COUNT (*)
    FROM GL_INTERFACE GLI, GL_SETS_OF_BOOKS SOB
   WHERE     SOB.SET_OF_BOOKS_ID(+) = GLI.SET_OF_BOOKS_ID --AND GLI.USER_JE_SOURCE_NAME = 'PEOPLESOFT HR'
