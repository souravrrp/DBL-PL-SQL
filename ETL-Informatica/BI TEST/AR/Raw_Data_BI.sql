/* Formatted on 7/12/2020 3:57:33 PM (QP5 v5.287) */
SELECT ABH.OPERATING_UNIT OU,
       ABH.CUSTOMER_NAME,
       ABH.BILL_NUMBER,
       ABH.BILL_DATE,
       ABH.BILL_CURRENCY,
       ...
       ROUND (ABD.UNIT_SELLING_PRICE * NVL (ABH.EXCHANCE_RATE, 1), 2)
          UNIT_SELLING_PRICE_BDT,
       ROUND ( (ABD.FINISHING_WEIGHT * ABD.UNIT_SELLING_PRICE), 2)
          "USD AMOUNT",
       ROUND (
            (ABD.FINISHING_WEIGHT * ABD.UNIT_SELLING_PRICE)
          * NVL (ABH.EXCHANCE_RATE, 1),
          2)
          "BDT AMOUNT"
  FROM w_xx_ar_bills_headers_all ABH,
       w_xx_ar_bills_lines_all ABL,
       w_xx_ar_bills_line_details_all ABD,
       w_xxdbl_yrn_type_data XYTD
